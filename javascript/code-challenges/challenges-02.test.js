...
let newarray=[];
arr.forEach(item =>newarray.push(Math.pow(item,3)));
return (newarray);
  // Solution code here...
};
...
const addOne = (arr) => {
  let newarray =arr.map(item=>item+1);
  return (newarray);
  // Solution code here...
};
...
const forEachTwoToThe = (arr) => {
    ...
    let newarray=[];
    arr.forEach(item=>newarray.push(Math.pow(2,item)));
...
const mapTwoToThe = (arr) => {
  let newarray=arr.map(item=>(Math.pow(2,item)));
  return newarray
  // Solution code here...
};
...
const charCode = (arr) => {
  let newarray =arr.map(item=>item.charCodeAt(0));
  return newarray;
  // Solution code here...
};
